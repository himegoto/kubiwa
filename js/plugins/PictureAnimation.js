...
(function () {
    ...
    Game_Interpreter.prototype.pluginCommandPictureAnimation = function (command, args) {
        var pictureNum, animationType, picture, cellNumber, frameNumber, direction, fadeDuration, wait, customArray,vnum,fnam;
        switch (getCommandName(command)) {
            ...
            case 'ピクチャのアニメーション準備':
                ...
                vnum  = getArgNumber(args[4], 1, settings.maxCellAnimation);
                fnam    = getArgString(args[5], true) || 'a';
				
                $gameScreen.setPicturesAnimation(cellNumber, frameNumber, direction, fadeDuration,vnum,fnam);
                break;
            case 'PA_START' :
            case 'ピクチャのアニメーション開始':
    ...
    //=============================================================================
    Game_Screen.prototype.setPicturesAnimation = function(cellNumber, frameNumber, direction, fadeDuration,vnum,fnam) {
    ...
    Game_Screen.prototype.showPicture = function(pictureId, name, origin, x, y,
        ...
        if (this._paCellNumber > 1) {
            this._pictures[realPictureId].setAnimationFrameInit(
                this._paCellNumber, this._paFrameNumber, this._paDirection, this._paFadeDuration,this._pavnum,this._pafnam);
    ...
    Game_Picture.prototype.fnam = function() {
        return this._fnam;
    };

    Game_Picture.prototype.vnum = function() {
        return this._vnum;
    };
    ...
    Object.defineProperty(Game_Picture.prototype, 'cell', {
        get: function() {
            ...
            switch (this._animationType) {
                case 3:
					var i=(this._customArray[this._cellCount] - 1).clamp(0, this._cellNumber - 1);
					if(i==0){i=this._customArray[1]-2;}
////////////////////////////////////////////////////////////////////////////////////////////////////////////
                    return i;
                case 2:
    ...
    Game_Picture.prototype.setAnimationFrameInit = function(cellNumber, frameNumber, direction, fadeDuration,vnum,fnam) {
    ...
    Sprite_Picture.prototype.updateAnimationFrame = function(sprite, cellCount) {
        ...
        switch (this.picture().direction()) {
            ...
            case 'vh横':
            case 'VH':
                var height = sprite.bitmap.height / (this.picture().cellNumber() / this.picture().vnum());
                var width = sprite.bitmap.width / this.picture().vnum();
                var x     = (cellCount % this.picture().vnum()) * width ;
                var y      = Math.floor(cellCount / this.picture().vnum()) * height;
