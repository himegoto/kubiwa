...
Window_Base.prototype.drawGauge = function(dx, dy, dw, rate, color1, color2) {
	...
	var gaugeY = dy + this.lineHeight() - gaugeH - 2;//////////////////////////52
...
Window_Base.prototype.drawActorTp = function(actor, x, y, width) {
 if(actor!=$gameParty.members()[1]){   width = width || 96;
...
Window_Status.prototype.drawParameters = function(x, y) {
    var lineHeight = this.lineHeight();
	var ct=6;if(this._actor==$gameParty.members()[1]){ct=1;}
    for (var i = 0; i < ct; i++) {
      var paramId = i + 2;
      ...
      this.resetTextColor();
//	  if(i==0){
//			var actorParam = Yanfly.Util.toGroup($gameParty.members()[1].param(paramId));
//			var dw = this.textWidth(Yanfly.Util.toGroup($gameParty.members()[1].paramMax(i + 2)));}
//		else{	
			var actorParam = Yanfly.Util.toGroup(this._actor.param(paramId));
